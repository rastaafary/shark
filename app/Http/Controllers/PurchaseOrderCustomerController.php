...
class PurchaseOrderCustomerController extends Controller
{
    ...
    public function addPurchaseOrder($id = null)
    {
        ...
        if (isset($uid) && $uid != null) {
            ...
            $cust_id = $cust->id;
            $shipping = DB::table('shipping_info')->where('customer_id', $cust_id)->first();
            return view('PurchaseOrderCustomer.addPurchaseOrder', ['page_title' => 'Add Purchase Order'])->with(array('shipping'=>$shipping));
        }
    }
