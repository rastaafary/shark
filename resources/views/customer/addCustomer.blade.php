            ...
            <section class="panel">
                <header class="panel-heading custom-tab dark-tab">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="{!!url('/customer/add')!!}"><?php echo isset($id) ? 'Edit' : 'Add'; ?></a></li>                       
                    </ul>
                </header>
                <div class="panel-body">
                    <div class="tab-content">
                        <div class="tab-pane active" id="Add">
                            ...
                            @else                             
                            {!! Form::open(array('class'=>'form-horizontal','url'=>'/customer/edit/'.$id,'name'=>'addCustomer','id'=>'editCustomer','files' => true)) !!}                              
                            {!! Form::hidden('id',Input::old('id',isset($cust->user_id) ?  $cust->user_id : '')) !!}
                            @endif
                            <div class="row">
                                <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                       <!-- <input type="text" class="form-control" id="faxNumber" placeholder="Fax Number"> -->
                                                        {!! Form::text('fax_number',Input::old('fax_number',isset($cust->fax_number) ? $cust->fax_number : '') ,array('class'=>'form-control', 'placeholder' => 'Fax Number')) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                     <!--  <input type="text" class="form-control" id="website" placeholder="Website">  -->
                                                        {!! Form::text('website',Input::old('website',isset($cust->website) ? $cust->website : '') ,array('class'=>'form-control', 'placeholder' => 'Website')) !!} 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            {!! Form::text('contact_name',Input::old('contact_name',isset($cust->contact_name) ? $cust->contact_name : '') ,array('class'=>'form-control', 'placeholder' => 'Contact Name')) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                           <!-- <input type="text" class="form-control" id="position" placeholder="Position"> -->
                                                            {!! Form::text('position',Input::old('position',isset($cust->position) ? $cust->position : '') ,array('class'=>'form-control', 'placeholder' => 'Position')) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                           <!-- <input type="text" class="form-control" id="contactEmail" placeholder="Contact Email"> -->  
                                                            {!! Form::text('contact_email',Input::old('contact_email',isset($cust->contact_email) ? $cust->contact_email : '') ,array('class'=>'form-control', 'placeholder' => 'Contact Email')) !!}
                                                        </div>
                                                    </div>
                                                </div>  
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                           <!-- <input type="text" class="form-control" id="contactMobile" placeholder="Contact Mobile"> -->
                                                            {!! Form::text('contact_mobile',Input::old('contact_mobile',isset($cust->contact_mobile) ? $cust->contact_mobile : '') ,array('class'=>'form-control', 'placeholder' => 'Contact Mobile')) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                         <!--   <input id="contactBirthdate" type="text" value="" size="16" class="form-control default-date-picker"> -->
                                                            {!! Form::text('contact_birthdate',Input::old('contact_birthdate',isset($cust->contact_birthdate) ? $cust->contact_birthdate : '') ,array('class'=>'form-control default-date-picker', 'placeholder' => 'Contact BirthDate', 'id' => 'birthdate')) !!}
                                                        </div>
                                                    </div> 
                                                </div>
                                            </div>
