                ...
                <div class="panel-body">
                    <div class="tab-content">
                        <div class="tab-pane active" id="Add">
                            ...
                            @else                             
                            {!! Form::open(array('class'=>'form-horizontal','url'=>'/customer/edit/'.$id,'name'=>'addCustomer','id'=>'addCustomer')) !!}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                         <!--   <input id="contactBirthdate" type="text" value="" size="16" class="form-control default-date-picker"> -->
                                                            {!! Form::text('contact_birthdate',Input::old('value',isset($cust->contact_birthdate) ? $cust->contact_birthdate : '') ,array('class'=>'form-control default-date-picker', 'placeholder' => 'Contact BirthDate', 'id' => 'birthdate')) !!}
                                                        </div>
                                                    </div> 
                                                </div>
                                            </div>
